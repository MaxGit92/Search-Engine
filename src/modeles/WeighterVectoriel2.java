...
public class WeighterVectoriel2 extends Weighter{

	public WeighterVectoriel2(String indexName, String invertedName, Index indexObjet) {
	...
	public HashMap<String,Double> getWeightsForQuery(HashMap<String,Integer> query) {
		...
		for(String key : query.keySet()){
			res.put(key, (double)query.get(key));
		}
		return res;
	}
